...
class Ricemill extends Admin_Controller 
{
    ...
    */
	public function index()
	{
		...
		$this->render_template('ricemill/index', $this->data);	
	}
	...
	public function fetchAssetData()
		{
			...
			for($i = 0; $i < count($response1); $i++)
			{
				$checkVars = array("JutebagWithRicemill","JutebagReturnedToWarehouse");
			...
			{
				$buttons = ''; 				
				if ($value["AssetStatus"] == "JutebagWithRicemill") 
				{
					$buttons = '<a href="'.base_url().'ricemill/returntowh/'.$value['JbAssetId'].'" class="label label-primary" role="button">&nbsp;&nbsp;&nbsp;&nbsp;ReturnToWH&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;';
					$value["AssetStatus"] = "Jutebag With Ricemill";
				} 
				if ($value["AssetStatus"] == "JutebagReturnedToWarehouse") 
				{
					$value["AssetStatus"] = "Returned To WH";
				} 
		...
		public function returntowh($product_id)
		{
			...
			$this->render_template('ricemill/returntowh', $this->data);
		}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('ricemill/', 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('ricemill/create', 'refresh');
        	}
        }
        else {
            // false case
            ...
            $this->render_template('ricemill/create', $this->data);
        }	
	}
	
	public function addjutemill()
	{
		$this->render_template('jutemill/addjutemill', $this->data);
	}
