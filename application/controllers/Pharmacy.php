<?php
	...
	class Pharmacy extends Admin_Controller
	{
		...
		public function sales()
		{
			...
			$this->render_template('pharmacy/sales', $this->data);
		}
		*/
		public function qc()
		{
			...
			//echo "<pre>"; print_r($this->data); exit();
			$this->render_template('pharmacy/qc', $this->data);
			//$this->load->view('pharmacy/index',$data);
		}
		...
		public function fetchAssetData()
		{
			...
			for($i = 0; $i < count($response1); $i++)
			{
			  ...
			  // 6 WhSendToPh   - User-4 Wholesaler 	// 7 PhSellToCo   - User-5 Pharmacy		
				$checkVars = array("WhSendToPh", "PhSellToCo");
		...
		*/
		...
		/*
			...
			* and it stores the operation message into the session flashdata and display on the manage product page
		*/
		public function sendtocs($product_id)
		{
			...
			$this->render_template('pharmacy/sendtocs', $this->data);
		}
