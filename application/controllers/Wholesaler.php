...
class Wholesaler extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Wholesaler';
	}
    ...
    */
	public function index()
	{
		...
		$this->render_template('wholesaler/index', $this->data);	
	}
	public function repk()
	{
		...
		$this->render_template('wholesaler/repk', $this->data);	
	}
	...
	public function fetchAssetData()
		{
			...
			for($i = 0; $i < count($response1); $i++)
			{
			  ...
			  // 6 WhSendToPh   - User-4 Wholesaler 	// 7 PhSellToCo   - User-5 Pharmacy		
				$checkVars = array("LspSendToWh" ,"WhSendToPh", "PhSellToCo");
	...
	public function disp()
		{
			...
			$this->data['DataTab']=$newdata1; 					
			//echo "<pre>"; print_r($this->data); exit();
			$this->render_template('wholesaler/distribution', $this->data);
		}

	public function sendtoph($product_id)
		{
			...
			$this->render_template('wholesaler/sendtoph', $this->data);
		}
    /*
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('wholesaler/', 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('wholesaler/create', 'refresh');
        	}
        }
        else {
            // false case
            ...
            $this->render_template('wholesaler/create', $this->data);
        }	
	}
