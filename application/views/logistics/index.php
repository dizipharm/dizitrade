...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li><li class="active">Logistics</li>
		</ol>
	</section>
							...
							<tbody> 
								<?php 
									...
									<tr>
										...
										<td> <?php if($key['AssetStatus'] == "PaFSendToLsp"){ ?>Handoff To LSP<?php }?><?php if($key['AssetStatus'] == "LspSendToWh"){ ?>Handoff To Wholesaler<?php }?><?php if($key['AssetStatus'] == "PhSellToCo"){ ?>Handoff To Customer<?php }?><?php if($key['AssetStatus'] == "WhSendToPh"){ ?>Handoff To Pharmacy<?php }?></td>
										<td> <?php if ($key['AssetStatus'] == "PaFSendToLsp"){ ?><a class="label label-success" role="button" href="<?php echo base_url()?>logistics/sendtowh/<?=$key['PhAssetId']?>"><b>SendToWhsle</b></a><?php }?> </td>
									</tr> 
									<?php 
									} 
									?>	
