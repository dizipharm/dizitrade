	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<h4 class="box-title"><b>Logistics</b></h4>
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Conform Product Details before Sending to Wholesaler/ Distributor</h3>
					</div>
					<!-- /.box-header -->
						...
						<table id="myData" class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									...
									<td><?php echo $QueryAsset["AssetName"]."<br>".$QueryAsset["AssetType"];?></td>
									...
									<td> <?php if($QueryAsset['AssetStatus'] == "PaFSendToLsp"){ ?>Send To Wholesaler<?php }?> </td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="box">
					...
					<div class="container-fluid mt-7">
						<div class="row">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Assign to New Owner(Wholesaler/ Distributor)</h3>
								</div>
								<!-- /.box-header -->
							</div>
							<div class="card-body">
										...
										<form action="javascript:">
											<div class="form-group">
												...
												<select class="form-control" id="assetholder" name="AssetHolder">
													<option selected="selected" value="Wholesaler" >Wholesaler (Distributor)</option>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														<option selected="selected" value="LspSendToWh">Handoff To Wholesaler</option>
													</select>
												</div>
												<!-- Date pikcer -->
												<div class="form-group">
												...
												<div class="form-group">
													<label for=""></label>
													<a href="<?php echo base_url(); ?>logistics/fetchAssetData/">
														<input  type="button" name="Cancel" value="Cancel"  class="btn btn-danger">
													</a>
													<input id="updateAsset" type="button" class="btn btn-success" value="Send To Whsle"/>
												</div>
											</div>
										</form>
									</div>
		...
		$("#updateAsset").click(function  (){ 
			...
			$.ajax({
				...
				success: function(response) {
					...
					location.href = "<?php echo base_url(); ?>logistics/fetchAssetData/";
				},
