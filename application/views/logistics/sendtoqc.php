										...
										<form action="javascript:">
											<div class="form-group">
												...
												<select class="form-control" id="assetholder" name="AssetHolder">
													...
													<option selected="selected" value="User2" >Quality Controll(QC)</option>
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														...
														<option selected="selected" value="QCUnloadingPending" >QC-Pending(Unloading)</option>
		...
		$("#updateAsset").click(function  (){
			...
			$.ajax({
				...
				success: function(response) {
						...
						location.href = "<?php echo base_url(); ?>logistics/";
						/*
