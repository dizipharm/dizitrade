...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Manage
			<small>Retailer/Pharmacy</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li><li class="active">Pharmacy</li>
		</ol>
	</section>
							...
							<tbody> 
								<?php 
									...
									<tr>
										...
										<td> <?php if($key['AssetStatus'] == "WhSendToPh"){ ?>Recieved<?php }?><?php if($key['AssetStatus'] == "PhSellToCo"){ ?>Handoff To Customer<?php }?> </td>										
										<td> <?php if ($key['AssetStatus'] == "WhSendToPh"){ ?><a class="label label-success" role="button" href="<?php echo base_url()?>pharmacy/sendtocs/<?=$key['PhAssetId']?>"><b>SendToCustomer</b></a><?php }?> </td>
									</tr> 
									<?php 
									} 
									?>	
