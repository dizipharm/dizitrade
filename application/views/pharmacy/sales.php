							...
							<tbody> 
								<?php 
									...
									<tr>
										...
										<td><?php if($key['AssetStatus'] == "PhSellToCo"){ ?>Handoff To Customer<?php }?></td>
										<td><?php if ($key['AssetStatus'] == "PhSellToCo"){ ?><a  class="label label-primary" role="button" href="#"><b>View</b></a><?php }?> </td>
									</tr> 
									<?php 
									} 
									?>	
