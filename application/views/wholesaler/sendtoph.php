	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<h4 class="box-title"><b>Wholesaler</b></h4>
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Conform Product Details before Sending to Pharmacy</h3>
					</div>
					<!-- /.box-header -->
						...
						<table id="myData" class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									...
									<td> <?php if($QueryAsset['AssetStatus'] == "LspSendToWh"){ ?>Send To Pharmacy<?php }?> </td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="box">
					...
					<div class="container-fluid mt-7">
						<div class="row">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Assign to New Owner(Pharmacy)</h3>
								</div>
								<!-- /.box-header -->
							</div>
							<div class="card-body">
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														<option selected="selected" value="WhSendToPh">Handoff To Pharmacy</option>
													</select>
												</div>
												<!-- Date pikcer -->
												<div class="form-group">
												...
												<div class="form-group">
													<label for=""></label>
													<a href="<?php echo base_url(); ?>wholesaler/disp/">
														<input  type="button" name="Cancel" value="Cancel"  class="btn btn-danger">
													</a>
													<input id="updateAsset" type="button" class="btn btn-success" value="Send To Pharma"/>
												</div>
											</div>
										</form>
									</div>
		...
		$("#updateAsset").click(function  (){ 
			...
			$.ajax({
				...
				success: function(response) {
					...
					location.href = "<?php echo base_url(); ?>wholesaler/disp/";
				},
