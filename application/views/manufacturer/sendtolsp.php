			...
			<div class="col-md-12 col-xs-12">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Conform Product Details before Sending to LSP</h3>
					</div>
					<!-- /.box-header -->
				...
				<div class="box">
					...
					<div class="container-fluid mt-7">
						<div class="row">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Assign to New Owner(Logistics)</h3>
								</div>
								<!-- /.box-header -->
							</div>
							<div class="card-body">
										...
										<form action="javascript:">
											<div class="form-group">
												...
												<select class="form-control" id="assetholder" name="AssetHolder">
													<option selected="selected" value="Logistics" >Logistics (LSP)</option>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														<option selected="selected" value="PaFSendToLsp">Handoff To Logistics</option>
													</select>
												</div>
												<!-- Date pikcer -->
												<div class="form-group">
													<label for="">Handoff Date</label>
													<input type="date" value="<?php echo date('Y-m-d'); ?>"  class="form-control" id="assign_date" name="Assign_Date" placeholder="Assugned Date">
												</div><br>
												<div class="form-group">
													<label for=""></label>
													<a href="<?php echo base_url(); ?>manufacturer/paf/">
														<input  type="button" name="Cancel" value="Cancel"  class="btn btn-danger">
													</a>
													<input id="updateAsset" type="button" class="btn btn-success" value="Send To LSP"/>
												</div>
											</div>
										</form>
									</div>
		...
		$("#updateAsset").click(function  (){ 
			...
			$.ajax({
				...
				success: function(response) {
					...
					location.href = "<?php echo base_url(); ?>manufacturer/paf/";
				},
