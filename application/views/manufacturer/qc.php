							...
							<tbody> 
								<?php 
									...
									<tr> 
										...
										<td> <?php if($key['AssetStatus'] == "MfgSendToQC"){ ?>QC Pending<?php }?><?php if($key['AssetStatus'] == "QCDone"){ ?>QC Done<?php }?><?php if($key['AssetStatus'] == "PhSellToCo"){ ?>Hand off To Customer<?php }?></td>										
										<td> <?php if ($key['AssetStatus'] == "MfgSendToQC"){ ?><a class="label label-success" role="button" href="<?php echo base_url()?>manufacturer/sendtoreport/<?=$key['PhAssetId']?>"><b>SendToReport</b></a><?php }?> </td>
									</tr> 
									<?php 
									} 
									?>	
