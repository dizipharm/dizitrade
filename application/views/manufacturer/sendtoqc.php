			...
			<div class="col-md-12 col-xs-12">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Conform Product Details before Sending to QC</h3>
					</div>
					<!-- /.box-header -->
				...
				<div class="box">
					...
					<div class="container-fluid mt-7">
						<div class="row">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Assign to New Owner(Quality Controll)</h3>
								</div>
								<!-- /.box-header -->
							</div>
							<div class="card-body">
										...
										<form action="javascript:">
											<div class="form-group">
												...
												<select class="form-control" id="assetholder" name="AssetHolder">
													<option selected="selected" value="QualityControll" >Quality Controll(QC)</option>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														<option selected="selected"  value="MfgSendToQC">QC-Pending</option>
													</select>
												</div>
												<!-- Date pikcer -->
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input id="updateAsset" type="button" class="btn btn-success" value="Submit"/>
												</div>
											</div>
										</form>
									</div>
