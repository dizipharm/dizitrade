...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Manage
			<small>Packing & Forward</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li><li class="active">Manufacturer</li>
		</ol>
	</section>
							...
							<tbody> 
								<?php 
									...
									<tr>
										...
										<td> <?php if($key['AssetStatus'] == "QCDone"){ ?>QC Done<?php }?><?php if($key['AssetStatus'] == "PhSellToCo"){ ?>Handoff To Customer<?php }?> <?php if($key['AssetStatus'] == "PaFSendToLsp"){ ?>Handoff To LSP<?php }?><?php if($key['AssetStatus'] == "WhSendToPh"){ ?>Handoff To Pharmacy<?php }?><?php if($key['AssetStatus'] == "LspSendToWh"){ ?>Handoff To Wholesaler<?php }?></td>
										<td><?php if ($key['AssetStatus'] == "QCDone"){ ?><a  class="label label-primary" role="button" href="<?php echo base_url()?>manufacturer/sendtolsp/<?=$key['PhAssetId']?>"><b>SendToLSP</b></a><?php }?> </td>
									</tr> 
									<?php 
									} 
									?>	
