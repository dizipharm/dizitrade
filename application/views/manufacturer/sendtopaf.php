										...
										<form action="javascript:">
											...
											<div class="form-group">
												...
												<select class="form-control" id="geoloc" name="GeoLoc">
													<option selected="selected" value="22.6226407,88.3538107">Ambica Jute Mill(22.6226407,88.3538107)</option>
													<option value="20.4630933,85.7977047">Cuttack,Odisha(20.4630933,85.7977047)</option>
													<option value="22.5902833,88.3217102">Vijayawada,AP(22.5902833,88.3217102)</option>
													<option value="18.5820235,78.4715534">Anantapur,AP (18.5820235,78.4715534)</option>
												</select>
											</div>
										</form>
									</div>
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														...
														<option selected="selected" value="HandoffToLogistics" >Handoff To Logistics</option>
												...
												<div class="form-group">
													...
													<input id="updateAsset" type="button" class="btn btn-success" value="Send To QC" />
												</div>
											</div>
										</form>
									</div>
