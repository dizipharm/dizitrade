	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<h4 class="box-title"><b>Manufacture</b></h4>
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Conform Product Details before Submiting to QC Report</h3>
					</div>
					<!-- /.box-header -->
						...
						<table id="myData" class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									...
									<td> <?php if($QueryAsset['AssetStatus'] == "MfgSendToQC"){ ?>QC Pending<?php }?> </td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="box">
					...
					<div class="container-fluid mt-7">
						<div class="row">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Assign to New Owner(Manufacturer)</h3>
								</div>
								<!-- /.box-header -->
							</div>
							<div class="card-body">
										...
										<form action="javascript:">
											<div class="form-group">
												...
												<select class="form-control" id="assetholder" name="AssetHolder">
													<option selected="selected" value="Celgene" >Celgene</option>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="form-group">
													...
													<select class="form-control" id="assetstatus" name="AssetStatus">
														<option selected="selected" value="QCDone" >QC-Done</option>
													</select>
												</div>
												<!-- Date pikcer -->
												<div class="form-group">
												...
												<div class="form-group">
													<label for=""></label>
													<a href="<?php echo base_url(); ?>manufacturer/qc/">
														<input  type="button" name="Cancel" value="Cancel"  class="btn btn-danger">
													</a>
													<input id="updateAsset" type="button" class="btn btn-success" value="Submit Report"/>
												</div>
											</div>
										</form>
									</div>
		...
		$("#updateAsset").click(function  (){ 
			...
			$.ajax({
				...
				success: function(response) {
					...
					location.href = "<?php echo base_url(); ?>manufacturer/qc/";
				},
